...
this["Fliplet"]["Widget"]["Templates"]["templates.components.map"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "  <input type=\"text\" class=\"form-control addressInput\" ref=\"mapAddressLookUp\" placeholder=\"Start typing your address..\">\n\n<div class=\"form-group fl-map-field maps\" style=\"width: 100%; height: 300px;\" ref=\"mapField\">\n  <div class=\"map-container\" style=\"width: 100%; height: 400px;\"></div>\n  <input type=\"hidden\" class=\"latitude\" />\n  <input type=\"hidden\" class=\"longitude\" />\n</div>\n";
},"useData":true});
